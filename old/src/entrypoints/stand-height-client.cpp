...
int main(const int argc, char *argv[]) {
    ...
    rclcpp::Client<rtsc_unitree_ros2::srv::StandHeight>::SharedPtr client =
        node->create_client<rtsc_unitree_ros2::srv::StandHeight>(SERVICE_NAME);
    ...
    // Send request
    auto request = std::make_shared<rtsc_unitree_ros2::srv::StandHeight_Request>();
