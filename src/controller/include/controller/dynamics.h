...
class Dynamics{
    ...
    public: 
        ...
        Eigen::Matrix3d getSkewSymMatrix(const Eigen::Vector3d& r); // 3d because we need r skewsym matrix, which is a position vector of xyz
        Eigen::Matrix3d getRotationMatrixRoll(double roll);
        Eigen::Matrix3d getRotationMatrixPitch(double pitch);
